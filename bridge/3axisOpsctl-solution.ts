 ...
 *   2) Ещё одна иерархия = PayloadCodec (+ Plain / Gzip / Archive)    — как упаковываем
 *   3) Implementation = DeliveryChannel (+ File / Stdout / Http / Ssh) — куда шлём
 *
 * Классический Bridge связывает две иерархии. Ось упаковки тем же приёмом
 * «вклеиваем» композицией: задание экспорта ДЕРЖИТ и кодек, и канал.
 ...
 * - ось упаковки по роли часто похожа на Strategy (подмена алгоритма),
...
// ═══════════════════════════════════════════════════════════════════════════
// ОСЬ 2 — PayloadCodec: «как упаковываем»
...
// ═══════════════════════════════════════════════════════════════════════════
// ОСЬ 3 — DeliveryChannel: «куда / как доставляем»
