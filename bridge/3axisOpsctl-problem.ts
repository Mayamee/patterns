 ...
 *   2) как упаковываем — plain / gzip / archive (tar-like)
 *   3) куда шлём       — файл / stdout / HTTP / SSH
 *
 * Оси ортогональны: «упаковать gzip» не зависит от того,
...
/** вторая ось: как готовим байты перед доставкой */
