...
- Если хочется сделать контекстный класс более стабильным (защитить его от изменений алгоритма который он использует и вынести часто меняющийся код в отдельный класс)
